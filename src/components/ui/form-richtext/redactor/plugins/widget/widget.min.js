Redactor.add('plugin', 'widget', {
  ...
  modals: {
    widget:
      '<form action="">                     <div class="form-item">                         <label for="modal-widget-input">## widget-html-code ##</label>                         <textarea id="modal-widget-input" name="widget" style="height: 200px;"></textarea>                     </div>                 </form>',
  },
  init: function (t) {
    (this.app = t),
      (this.lang = t.lang),
    ...
    widget: {
      opened: function (t, e) {
        if ((e.getField('widget').focus(), this.$currentItem)) {
          var i = decodeURI(this.$currentItem.attr('data-widget-code'));
  ...
  start: function () {
    var t = { title: this.lang.get('widget'), api: 'plugin.widget.open', observe: 'widget' };
  ...
  _insert: function (t) {
    if ((this.app.api('module.modal.close'), '' !== t.widget.trim())) {
      var e = this._isHtmlString(t.widget) ? t.widget : document.createTextNode(t.widget),
        i = this.component.create('widget', e);
