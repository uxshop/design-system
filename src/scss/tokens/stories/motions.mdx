...
<Meta title="Design Tokens/Motions" />
...
<DesignTokenDocBlock categoryName="Motions" maxHeight="auto" />

## Duration

<DesignTokenDocBlock categoryName="Motions Duration" maxHeight="auto" />
